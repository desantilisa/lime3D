...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 13:49:43 2024
...
__all__ = ['ResNet3D', 'resnet_18_3d', 'resnet_18_3d_features',]
...
class ResNet3D(nn.Module):
    ...
    def __init__(self,
        ...
        self.fc = torch.nn.Sequential(
            ...
            torch.nn.Linear(in_features=512 * block.expansion, out_features=num_classes, bias=True))
...
def resnet_18_3d(pretrained=True, **kwargs):
    ...
    if pretrained:
        model_path = "/home/lisadesanti/DeepLearning/Lisa/pretrained_backbones/resnet3d_pretrained/resnet_18.pth"
...
def resnet_18_3d_features(pretrained=True, **kwargs):

    """ Build a ResNet-18 model. """

    model = ResNet3D_features(BasicBlock, [2, 2, 2, 2], **kwargs)
